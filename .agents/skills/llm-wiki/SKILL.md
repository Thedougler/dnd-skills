...
name: llm-wiki
description: >
  The foundational knowledge distillation pattern (Karpathy llm-wiki): compile raw sources
  into a maintained wiki under a schema. In this repository Campaign OS is that wiki —
  use whenever the user wants the pattern, three-layer architecture, config resolution,
  ledgers, provenance, link format, or QMD primitives. Operations live in wiki-ingest,
  wiki-query, and sibling skills; kind/layer rules live in CONTEXT.md.
---
